...
type ".\recommend_targets_empty.json" ^
  | vegeta attack -format=json -rate=100 -duration=60s ^
    ...
    -output="results\recommend_empty_100_RPS.bin"

vegeta report -type=text "results\recommend_empty_100_RPS.bin" > "results\recommend_empty_100_RPS.txt"
vegeta plot "results\recommend_empty_100_RPS.bin" > "results\recommend_empty_100_RPS.html"

echo Done. Open results\recommend_empty_100_RPS.html in your browser.
