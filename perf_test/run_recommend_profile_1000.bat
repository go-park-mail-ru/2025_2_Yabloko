...
type ".\recommend_targets_profile.json" ^
  | vegeta attack -format=json -rate=1000 -duration=60s ^
    ...
    -output="results\recommend_profile_1000_RPS.bin"

vegeta report -type=text "results\recommend_profile_1000_RPS.bin" > "results\recommend_profile_1000_RPS.txt"
vegeta plot "results\recommend_profile_1000_RPS.bin" > "results\recommend_profile_1000_RPS.html"

echo Done. Open results\recommend_profile_1000_RPS.html in your browser.
